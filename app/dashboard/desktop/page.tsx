const htmlFile = `
<div pbi-resize="powerbi" pbi-resize-src="https://app.powerbi.com/view?r=eyJrIjoiODRhODdmZjgtYjNjMi00YWZmLTllMmQtMDk2MmM4OTBmOGZmIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9" pbi-resize-min-width="600" pbi-default-width="600px" pbi-default-height="488" pbi-resize-width="16" pbi-resize-height="7.27" pbi-resize-load-event="page-load" pbi-resize-header="true" style="position: relative;"><iframe frameborder="0" allowfullscreen="true"></iframe></div><script type="text/javascript">
