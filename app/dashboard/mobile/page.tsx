...
<body>
<div pbi-resize="powerbi" pbi-resize-src="https://app.powerbi.com/view?r=eyJrIjoiZjg0OTg0ODYtNGJkNi00NWQ5LWFhZWUtMzQ4ZDNjZWNhMTFlIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9" pbi-resize-min-width="600" pbi-default-width="600px" pbi-default-height="488" pbi-resize-width="450" pbi-resize-height="1600" pbi-resize-load-event="page-load" pbi-resize-header="true" style="position: relative;"><iframe frameborder="0" allowfullscreen="true"></iframe></div><script type="text/javascript">
  ...
  <!-- <svg class="overlay" width="100%" height="50">
    <rect x="80%" y="20%" width="40%" height="40%" fill="rgba(128, 128, 128)" />
  </svg> -->
</body>
</html>
`;
